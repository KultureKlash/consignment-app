...
import type { Consignor } from "@prisma/client";

interface ConsignorsListPageProps {
  consignors: Consignor[];
  balances: Record<string, number>;
}

export function ConsignorsListPage({ consignors, balances }: ConsignorsListPageProps) {
